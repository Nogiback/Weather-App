...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _weatherHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./weatherHandler */ "./src/weatherHandler.js");
...
const domHandler = (() => {
  function initPage() {
    ...
    submitBtn.addEventListener('click', async () => {
      ...
      const weatherData = await _weatherHandler__WEBPACK_IMPORTED_MODULE_0__["default"].getWeatherData(searchInput.value);
    ...
    const initPromise = new Promise((resolve, reject) => {
      const initLocation = _weatherHandler__WEBPACK_IMPORTED_MODULE_0__["default"].getWeatherData('Toronto');
...
const weatherHandler = (() => {
  ...
  function convertWeatherData(weatherData) {
    const data = {
      ...
      date: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(weatherData.location.localtime), 'EEEE MMMM d, y | h:mma'),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (weatherHandler);
