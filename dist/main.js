...
const weatherHandler = (() => {
  ...
  function convertWeatherData(weatherData) {
    const data = {
      ...
      date: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(weatherData.location.localtime), 'EEEE, MMMM d, y'),
      timeOfDay: Number((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(weatherData.location.localtime), 'k')),
    };
    return data;
  }
